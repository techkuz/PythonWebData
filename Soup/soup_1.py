...
Actual data: http://python-data.dr-chuck.net/comments_311216.html (Sum ends with 60)
...
#url = raw_input()
html = urllib.urlopen('http://python-data.dr-chuck.net/comments_311216.html').read()
